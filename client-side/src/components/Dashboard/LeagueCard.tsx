...
const LeagueCard = ({ league }: ILeagueCardProps) => {
  return (
    <div className="w-[calc(100%/2)] p-[15px]">
      <div className="border-[1px] border-[gray] rounded-[4px] hover:scale-105 duration-300 ease-in cursor-pointer hover:border-primary p-[10px]">
        <div>
          <h1 className="text-center text-primary font-semibold text-[25px] font-ss3">
            {league.name}
          </h1>
        </div>
        <p className="text-[gray] mt-[10px]">{types[league.type_id as keyof IMatchTypes]} Format</p>
