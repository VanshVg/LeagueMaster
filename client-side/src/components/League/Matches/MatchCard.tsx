...
const MatchCard = ({ data }: IRecentMatchCardProps) => {
  return (
    <div className="border-[1px] text-primaryText border-primaryText py-[10px] mx-auto mt-[15px] rounded-[4px]">
      ...
      <div className="flex justify-evenly gap-[20px] max-h-[60px] px-[10px] mt-[20px]">
        <p className="text-primary text-[23px] mt-[13px]">
        ...
        {data.status === "pending" ? (
          ...
          <div className="flex text-[40px] text-secondary">
            <div>
              ...
              {data.penalties && (
                <p className="text-[20px] -mt-[15px]">
                  ({data.match_penalty_scores.home_team_score})
                </p>
              )}
            </div>
            ...
            <div>
              ...
              {data.penalties && (
                <p className="text-[20px] -mt-[15px]">
                  ({data.match_penalty_scores.away_team_score})
                </p>
              )}
            </div>
          </div>
